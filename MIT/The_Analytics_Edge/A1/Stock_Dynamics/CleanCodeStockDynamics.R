...
cat(" Coca Cola's stock price was $", CocaCola_price_at_min_date, "on", CocaCola_formatted_min_date, ".")
summary(CocaCola)
...
# prints out the stock with the min mean stock price over the period
cat(min_min_stock_price_name, "This was the minimum minimum stock price of all stocks over this period.")
